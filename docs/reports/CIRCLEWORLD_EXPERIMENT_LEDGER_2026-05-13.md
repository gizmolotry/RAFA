...
- Generated at: `2026-05-23T11:28:14Z`
...
- Since: `2026-05-17`
- Entries: `25` total, `5` report-derived, `20` output-only
...
| --- | --- | --- | --- | ---: |
| 2026-05-22 | report | This pass extended the phase-native audio route-head evidence from a single fourth-lockbox replay into a four-fold leave-one-lockbox-out... | `parametric_reference.mean_child_writeback_mass`=0.0852572; `sibling_case_count`=24; `objective_score_mlp_v1`=[4, 4, 4]; `mean_isolated_coherence`=0.680792 | 2 |
...
### 1. 2026-05-22 - This pass extended the phase-native audio route-head evidence from a single fourth-lockbox replay into a four-fold le...

- Source kind: `report`
- Source path: `docs\reports\CIRCLEWORLD_PHASE_NATIVE_NONKNN_LOOCV_AND_CHILDIFS_DEEP_2026-05-22.md`
- Claim/test: This pass extended the phase-native audio route-head evidence from a single fourth-lockbox replay into a four-fold leave-one-lockbox-out suite, then wrapped every held-out selected-route run in circleworld_operator_block_v1.
- Interpretation: The route-head lane now has a clean internal hierarchy:
...
- Metrics:
  - `parametric_reference.mean_child_writeback_mass`: `0.0852572`
  - `sibling_case_count`: `24`
  - `objective_score_mlp_v1`: `[4, 4, 4]`
  - `mean_isolated_coherence`: `0.680792`
  - `mean_sibling_phase_delta`: `0.360528`
  - `sandbox_mean_writeback_delta`: `5e-08`
  - `mean_parent_writeback_divergence`: `6.7e-07`
  - `feature_stats.mode0_coherence.max`: `0.780085`
  - `feature_stats.mode0_coherence.min`: `0.0795137`
  - `feature_stats.mode0_coherence.std`: `0.158907`
  - `feature_stats.mode1_coherence.max`: `0.743944`
  - `feature_stats.mode1_coherence.min`: `0.0410285`
  - `feature_stats.mode1_coherence.std`: `0.174289`
  - `target_stats.coherence_target.max`: `0.409887`
  - `target_stats.coherence_target.min`: `0.0360041`
  - `target_stats.coherence_target.std`: `0.0806569`
  - `feature_stats.mode0_coherence.mean`: `0.390491`
  - `feature_stats.mode1_coherence.mean`: `0.213262`
- Artifact paths:
...
### 2. 2026-05-22 - This pass tested two learned Circleworld components without returning to KNN:
...
### 3. 2026-05-22 - Two non-KNN GPU-backed Circleworld attempts were tested:
...
### 4. 2026-05-22 - Adding explicit no-future reentry/query features to the Circleworld phase-native route feature surface improves non-K...
...
### 7. 2026-05-21 - Output artifact scan: phase_native_audio_objective_policy_audit_v1
...
### 10. 2026-05-21 - Output artifact scan: phase_native_audio_route_selector_contract_audit_v1
...
### 11. 2026-05-20 - Output artifact scan: rafa_cpu_phase_heat_worker_v1
...
### 12. 2026-05-20 - Output artifact scan: circleworld_internal_phase_law_variant_compare_v0
...
### 13. 2026-05-18 - Output artifact scan: phase_native_audio_route_selector_contract_audit_v1
...
### 14. 2026-05-17 - The rebuilt 2026-05-17 lockbox selected 62 cases from 10 predeclared groups with no unmet minimum groups:
...
### 20. 2026-05-17 - Output artifact scan: circleworld_audio_continuation_v0
...
### 21. 2026-05-17 - Output artifact scan: phase_native_audio_prefix_router_scout_v1
...
### 22. 2026-05-17 - Output artifact scan: phase_native_audio_reentry_metric_audit_v1
...
### 24. 2026-05-17 - Output artifact scan: circleworld_audio_continuation_v0
...
### 25. 2026-04-28 - Output artifact scan: dag_health_audit_2026-04-28
...
```jsonl
{"artifact_paths": ["D:\\RAFA\\outputs\\circleworld_proto\\phase_native_audio_loocv_2026-05-22_gpu_nonknn", "D:\\RAFA\\outputs\\circleworld_proto\\learned_branch_law_child_ifs_assay_2026-05-22_causal_guarded_deep_gain12\\learned_branch_law_assay.json"], "claim_test": "This pass extended the phase-native audio route-head evidence from a single fourth-lockbox replay into a four-fold leave-one-lockbox-out suite, then wrapped every held-out selected-route run in circleworld_operator_block_v1.", "date": "2026-05-22", "interpretation": "The route-head lane now has a clean internal hierarchy:", "limitations": "Not explicitly reconstructed from this report.", "metrics": {"feature_stats.mode0_coherence.max": 0.78008533, "feature_stats.mode0_coherence.mean": 0.39049074, "feature_stats.mode0_coherence.min": 0.07951365, "feature_stats.mode0_coherence.std": 0.15890674, "feature_stats.mode1_coherence.max": 0.74394441, "feature_stats.mode1_coherence.mean": 0.2132622, "feature_stats.mode1_coherence.min": 0.04102845, "feature_stats.mode1_coherence.std": 0.17428891, "mean_isolated_coherence": 0.68079207, "mean_parent_writeback_divergence": 6.7e-07, "mean_sibling_phase_delta": 0.36052848, "objective_score_mlp_v1": [4, 4, 4], "parametric_reference.mean_child_writeback_mass": 0.0852572, "sandbox_mean_writeback_delta": 5e-08, "sibling_case_count": 24, "target_stats.coherence_target.max": 0.40988716, "target_stats.coherence_target.min": 0.03600411, "target_stats.coherence_target.std": 0.08065686}, "next_action": "Review source report and linked artifacts before promotion.", "source_kind": "report", "source_path": "docs\\reports\\CIRCLEWORLD_PHASE_NATIVE_NONKNN_LOOCV_AND_CHILDIFS_DEEP_2026-05-22.md"}
