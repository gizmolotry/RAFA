...
DEFAULT_INIT_CONFIG = ROOT / "outputs" / "circleworld_proto" / "branchlaw_ablation_series_2026-04-17" / "relational_qkv_v2_ramanujan" / "checkpoint" / "circleworld_real_anchor_config_cem_v1.json"
...
def _token_diversity_score_cfg() -> dict[str, float]:
    return {
        "target_corr": 0.77,
        "target_mae": 0.088,
        "target_dom": 0.62,
...
def run_experiment(
    ...
    train_summary = train_circleworld_real_anchor(
        ...
        score_cfg=_token_diversity_score_cfg(),
    ...
    summary = {
        ...
        "mode": "token_diversity_experiment",
    ...
    _write_json(out_dir / "token_diversity_experiment_summary.json", summary)
    return summary


def main() -> None:
    ap = argparse.ArgumentParser(description="Run the Circleworld Ramanujan token-diversity training experiment with sidecars.")
